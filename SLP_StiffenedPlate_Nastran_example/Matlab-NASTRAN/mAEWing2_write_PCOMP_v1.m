function mAEWing2_write_PCOMP_v1(design_folder,pcomp_bdf_file_name,...
                               PCOMP_label,section,...
...
if strcmp(Sym_flag,'SYM')  
    pcomp_line_dat = ['PCOMP   ' num2str_integer(PCOMP_label)   Z0 '        ' num2str8(bond_shearstress) FT '                SYM'];
    fprintf(fid101,'%s\n',pcomp_line_dat);

else

    pcomp_line_dat = ['PCOMP   ' num2str_integer(PCOMP_label)   Z0 '        ' num2str8(bond_shearstress) FT];
    fprintf(fid101,'%s\n',pcomp_line_dat);
