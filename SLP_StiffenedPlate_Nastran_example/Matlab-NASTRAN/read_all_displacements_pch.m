function [displacements,disp_ratios] = read_all_displacements_pch(pchfname,minodeid,maxnodeid,MAX_disp_rot,cases_num)
...
while currentFPI<EOF && stop_flag &&  subcase_id<=cases_num
    ...
    subcase_id= str2num(linef06(24:27));
...
%             eval(['modeshape' num2str(mode) '(1,1:7)=[NaturalFrequency(' num2str(mode) '),0,0,0,0,0,0];']);
            ...
            while currentFPI<EOF && flag && nodeid<=maxnodeid
                ...
                if isempty(nodeid)==1 
                   ...
                   displacements(jj,1,subcase_id)=str2num(linef06(1:10));
                    
%                     str2num(linef06(20:72))
                    disp_xyz = str2num(linef06(20:72));
                    displacements(jj,2:4,subcase_id)= disp_xyz;
...
%                     str2num(linef06(20:72))
                   ...
                   displacements(jj,5:7,subcase_id) = beta_xyz;
                    
                   disp_ratios(jj,1:2,subcase_id) = [disp_xyz(3) -disp_xyz(3)]/MAX_disp_rot(1);
                   disp_ratios(jj,3:4,subcase_id) = [beta_xyz(1) -beta_xyz(1)]/MAX_disp_rot(2);
                   disp_ratios(jj,5:6,subcase_id) = [beta_xyz(2) -beta_xyz(2)]/MAX_disp_rot(3);
