function [c,ceq,gradc,gradceq] = nonlinear_constraints_SP_just_disp(x0)
...
% % % % 
% % % % c(4+1:4+length(initial_values)) = initial_values/C_UB  - ones(length(initial_values),1);
% % % % 
% % % % gradc(:,4+1:4+length(initial_values)) = senstivity_matrix'/C_UB;
% % % % 
% % % % 
% % % % 
% % % % 
