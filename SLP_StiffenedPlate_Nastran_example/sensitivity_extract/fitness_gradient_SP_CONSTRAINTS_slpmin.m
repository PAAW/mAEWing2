function [c,ceq,gradc,gradceq] = fitness_gradient_SP_CONSTRAINTS_slpmin(x0)
...
upper_level_path = fileparts(pwd);
design_folder = [upper_level_path filesep 'verification_stiffened_plate'];
main_folder = pwd;
