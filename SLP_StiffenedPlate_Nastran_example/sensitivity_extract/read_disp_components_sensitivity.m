...
function [disp0,disp_sens] = read_disp_components_sensitivity(filename,DESVAR_labels,DRESP1_ID)
        ...
        while length(linebdf)>1 && isempty(dresp1_index )==0
            ...
            if length(linebdf)>45 && isempty(str2num(linebdf(37:45))) == 0
                ...
                if isempty(str2num(linebdf(14:24))) == 0
                    ...
                    disp0 = [disp0 ;str2num(linebdf(14:24))];
                ...
                disp_sens =[ disp_sens;    stress_sens_temp];
